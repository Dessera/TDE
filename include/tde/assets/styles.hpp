...
public:
   ...
   */
  static QString generate(Scope scope);
   ...
   * @return QString Qss content.
   */
  static QString generate(const QStringList& files);
   ...
   * @return QString Qss content.
   */
  static QString generate(Scope scope, const QStringList& files);
   ...
   * @return QString Qss content.
   */
  static QString generate(Scope scope, const QString& files);
};
